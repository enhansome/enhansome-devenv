...
Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 181,375 | 🐛 213 | 🌐 Go | 📅 2026-08-16, which was in turn inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 314,608 | 🐛 16 | 🌐 Python | 📅 2026-08-16.
...
* [s3cmd](https://github.com/s3tools/s3cmd) ⭐ 4,900 | 🐛 311 | 🌐 Python | 📅 2025-10-22 - the S3 CLI tool for Amazon

## Diagnostics

*Tools for checking diagnosing your system while you work*

* [glances](https://github.com/nicolargo/glances) ⭐ 33,371 | 🐛 107 | 🌐 Python | 📅 2026-08-18
...
* [Mathias Bynens's](https://github.com/mathiasbynens/dotfiles) ⭐ 31,452 | 🐛 186 | 🌐 Shell | 📅 2024-08-05 - .files, including \~/.osx — sensible hacker defaults for OS X
...
* [Dev Git Repo](https://github.com/Microsoft/vscode) ⭐ 188,896 | 🐛 19,969 | 🌐 TypeScript | 📅 2026-08-18 - Github code repository for VS Code
* [Monaco Editor Git Repo](https://github.com/microsoft/monaco-editor) ⭐ 46,551 | 🐛 846 | 🌐 JavaScript | 📅 2026-08-15 - Github code repository for underlying browser-based editor
...
* [reveal.js](https://github.com/hakimel/reveal.js/) ⭐ 72,142 | 🐛 913 | 🌐 JavaScript | 📅 2026-05-21 - markdown based presentation on your browser
...
* [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh/) ⭐ 189,240 | 🐛 599 | 🌐 Shell | 📅 2026-08-17 - A community driven framework for managing zsh configuration.
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 39,887 | 🐛 1,138 | 🌐 Haskell | 📅 2026-08-04 - Lint for shell. Will find deprecated and/or dangerous usage in shell scripts
* [fish-shell](https://github.com/fish-shell/fish-shell) ⭐ 34,032 | 🐛 570 | 🌐 Rust | 📅 2026-08-17 - The user-friendly command line shell
* [awesome-zsh-plugins](https://github.com/unixorn/awesome-zsh-plugins) ⭐ 17,937 | 🐛 6 | 🌐 Shell | 📅 2026-08-16 - List of zsh plugins usable with [zgen](https://github.com/tarjoilija/zgen) ⭐ 1,528 | 🐛 41 | 🌐 Shell | 📅 2021-07-21 and other [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh/) ⭐ 189,240 | 🐛 599 | 🌐 Shell | 📅 2026-08-17 compatible zsh frameworks
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,369 | 🐛 178 | 🌐 Rust | 📅 2026-08-04 - Faster than grep, written in Rust
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,104 | 🐛 564 | 🌐 C | 📅 2024-06-16 - A C based code-searching tool similar to ack, but faster
...
* [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,240 | 🐛 599 | 🌐 Shell | 📅 2026-08-17 - the
  incredible ZSH addon.
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,700 | 🐛 139 | 🌐 Rust | 📅 2026-08-17 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
...
* [watchman](https://github.com/facebook/watchman) ⭐ 13,682 | 🐛 252 | 🌐 C++ | 📅 2026-08-17 - Facebook's better
