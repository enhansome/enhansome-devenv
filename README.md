...
Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 183,316 | 🐛 224 | 🌐 Go | 📅 2026-09-06, which was in turn inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 318,724 | 🐛 17 | 🌐 Python | 📅 2026-09-01.

### Contributing

[Guidelines](https://github.com/jondot/awesome-devenv/blob/master/CONTRIBUTING.md) ⭐ 3,338 | 🐛 42 | 📅 2024-07-29 tweaked and adapted from `awesome-go` - thanks!

But in short:

* If you think an item shouldn't be here [open an issue](https://github.com/jondot/awesome-devenv/issues/new) ⭐ 3,338 | 🐛 42 | 📅 2024-07-29
* List is alphabetically sorted

Many thanks to everyone on the [contributor list](https://github.com/jondot/awesome-devenv/graphs/contributors) ⭐ 3,338 | 🐛 42 | 📅 2024-07-29 :)
...
* [wrk](https://github.com/wg/wrk) ⭐ 40,404 | 🐛 203 | 🌐 C | 📅 2023-12-30
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 25,178 | 🐛 122 | 🌐 Go | 📅 2026-02-16
* [boom](https://github.com/rakyll/boom) ⚠️ Archived
* [phantomas](https://github.com/macbre/phantomas) ⭐ 2,260 | 🐛 66 | 🌐 JavaScript | 📅 2026-08-31 - website perf evaluation tool
...
* [s3cmd](https://github.com/s3tools/s3cmd) ⭐ 4,907 | 🐛 311 | 🌐 Python | 📅 2025-10-22 - the S3 CLI tool for Amazon

## Diagnostics

*Tools for checking diagnosing your system while you work*

* [glances](https://github.com/nicolargo/glances) ⭐ 33,531 | 🐛 101 | 🌐 Python | 📅 2026-09-05
* [gtop](https://github.com/aksakalli/gtop) ⭐ 9,931 | 🐛 40 | 🌐 JavaScript | 📅 2025-11-06
...
* [Mathias Bynens's](https://github.com/mathiasbynens/dotfiles) ⭐ 31,469 | 🐛 186 | 🌐 Shell | 📅 2024-08-05 - .files, including \~/.osx — sensible hacker defaults for OS X
* [Thoughtbot's](https://github.com/thoughtbot/dotfiles) ⭐ 8,173 | 🐛 18 | 🌐 Shell | 📅 2026-09-03 - A set of vim, zsh, git, and tmux configuration files
* [Zach Holman's](https://github.com/holman/dotfiles) ⭐ 7,768 | 🐛 33 | 🌐 Shell | 📅 2026-06-25 - oh-my-zsh, osx, Zsh, vi, Ruby, Git, and more
* [Paul Miller's](https://github.com/paulmillr/dotfiles) ⭐ 1,241 | 🐛 2 | 🌐 Vim Script | 📅 2026-09-03 - Colourful & robust OS X configuration files and utilities
...
* [atom-beautify](https://github.com/Glavin001/atom-beautify) ⭐ 1,502 | 🐛 402 | 🌐 CoffeeScript | 📅 2026-02-14 - Beautify HTML (including Handlebars), CSS (including Sass and Less), JavaScript, and much more in Atom.
* [file-icons](https://github.com/DanBrooker/file-icons) ⭐ 1,375 | 🐛 28 | 🌐 JavaScript | 📅 2025-12-28 - Adds file specific icons to atom for improved visual grepping.
...
* [highlight-selected](https://github.com/richrace/highlight-selected) ⭐ 246 | 🐛 52 | 🌐 JavaScript | 📅 2023-01-03 - Double click on a word to highlight it throughout the open file.
...
* [Powerline](https://github.com/Lokaltog/powerline) ⭐ 14,810 | 🐛 242 | 🌐 Python | 📅 2026-03-11 - improved status bar for your buffers.
...
* [Emmet](https://github.com/sergeche/emmet-sublime) ⭐ 5,215 | 🐛 194 | 🌐 JavaScript | 📅 2023-06-28
* [Git Gutter](https://github.com/jisaacks/GitGutter) ⭐ 3,878 | 🐛 9 | 🌐 Python | 📅 2026-03-21 - display changed/added lines in the margin of the editor window.
* [MarkdownEditing](https://github.com/SublimeText-Markdown/MarkdownEditing) ⭐ 3,325 | 🐛 47 | 🌐 Python | 📅 2026-08-21 - Markdown syntax understanding and good color schemes.
...
* [Sublime Linter](https://github.com/SublimeLinter/SublimeLinter3/) ⭐ 2,039 | 🐛 19 | 🌐 Python | 📅 2026-01-23 - Interactive code linting.
...
* [AdvancedNewFile](https://github.com/skuroda/Sublime-AdvancedNewFile) ⭐ 832 | 🐛 28 | 🌐 Python | 📅 2024-04-07 - File creation plugin.
...
* [Dev Git Repo](https://github.com/Microsoft/vscode) ⭐ 190,959 | 🐛 20,645 | 🌐 TypeScript | 📅 2026-09-06 - Github code repository for VS Code
* [Monaco Editor Git Repo](https://github.com/microsoft/monaco-editor) ⭐ 46,675 | 🐛 855 | 🌐 JavaScript | 📅 2026-09-03 - Github code repository for underlying browser-based editor
...
* [git-extras](https://github.com/visionmedia/git-extras) ⭐ 18,103 | 🐛 96 | 🌐 Shell | 📅 2026-09-01 - GIT utilities -- repo summary, repl, changelog population, author commit percentages and more
...
* [git-sweep](https://github.com/arc90/git-sweep) ⭐ 2,710 | 🐛 45 | 🌐 Python | 📅 2023-10-01 - safely removes branches that have been merged into the master
* [git-up](https://github.com/aanand/git-up) ⭐ 2,587 | 🐛 36 | 🌐 Ruby | 📅 2017-11-07 - a better 'git pull'
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) ⭐ 1,170 | 🐛 2 | 🌐 Shell | 📅 2026-09-04 - collected git helper scripts
* [gh](https://github.com/jingweno/gh) ⭐ 717 | 🐛 15 | 🌐 Go | 📅 2022-10-07 - Fast GitHub command line client (hub port to Go)
* [awesome-github](https://github.com/fffaraz/awesome-github) ⭐ 542 | 🐛 6 | 📅 2026-03-20 - Faraz Fallahi maintains a curated list of GitHub & Git resources.
...
* [ML Workspace](hhttps://github.com/ml-tooling/ml-workspace) ⭐ 3,545 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2024-07-26 - All-in-one web-based development environment for machine learning and data science.
...
* [Nanobox](https://github.com/nanobox-io/nanobox) ⭐ 1,633 | 🐛 76 | 🌐 Go | 📅 2019-10-21 - A micro-PaaS (μPaaS) for creating consistent, isolated, development environments deployable anywhere <https://nanobox.io>.
...
* [reveal.js](https://github.com/hakimel/reveal.js/) ⭐ 72,262 | 🐛 912 | 🌐 JavaScript | 📅 2026-08-24 - markdown based presentation on your browser
* [impress.js](https://github.com/impress/impress.js) ⭐ 38,170 | 🐛 59 | 🌐 JavaScript | 📅 2026-07-23 - presentation framework based on the power of CSS3 transforms and transitions
* [remark](https://github.com/gnab/remark) ⭐ 13,002 | 🐛 181 | 🌐 JavaScript | 📅 2024-06-19 - markdown based presentation on your browser
* [WebSlides](https://github.com/jlantunez/webslides) ⭐ 6,320 | 🐛 78 | 🌐 JavaScript | 📅 2022-12-10 - Making HTML presentations easy
* [deck.js](https://github.com/imakewebthings/deck.js) ⭐ 5,420 | 🐛 42 | 🌐 JavaScript | 📅 2019-01-28 - markdown based presentation on your browser
* [bespoke.js](https://github.com/markdalgleish/bespoke.js) ⭐ 4,796 | 🐛 6 | 🌐 JavaScript | 📅 2020-09-08 - DIY Presentation Micro-Framework
...
* [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh/) ⭐ 189,581 | 🐛 429 | 🌐 Shell | 📅 2026-09-06 - A community driven framework for managing zsh configuration.
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 39,997 | 🐛 1,139 | 🌐 Haskell | 📅 2026-08-04 - Lint for shell. Will find deprecated and/or dangerous usage in shell scripts
* [fish-shell](https://github.com/fish-shell/fish-shell) ⭐ 34,142 | 🐛 563 | 🌐 Rust | 📅 2026-09-05 - The user-friendly command line shell
* [awesome-zsh-plugins](https://github.com/unixorn/awesome-zsh-plugins) ⭐ 17,996 | 🐛 6 | 🌐 Shell | 📅 2026-09-06 - List of zsh plugins usable with [zgen](https://github.com/tarjoilija/zgen) ⭐ 1,528 | 🐛 41 | 🌐 Shell | 📅 2021-07-21 and other [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh/) ⭐ 189,581 | 🐛 429 | 🌐 Shell | 📅 2026-09-06 compatible zsh frameworks
* [oh-my-fish](https://github.com/oh-my-fish/oh-my-fish) ⭐ 11,387 | 🐛 5 | 🌐 Shell | 📅 2026-08-30 - Framework for managing your fish shell configuration inspired by oh-my-zsh.
...
* [zsh quickstart kit](https://github.com/unixorn/zsh-quickstart-kit) ⭐ 910 | 🐛 16 | 🌐 Shell | 📅 2026-08-22 - Quick intro for getting set up with zsh and zgen
* [hss](https://github.com/six-ddc/hss) ⭐ 380 | 🐛 10 | 🌐 C | 📅 2025-10-17 - Never type the annoying ssh commands again.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,999 | 🐛 187 | 🌐 Rust | 📅 2026-08-04 - Faster than grep, written in Rust
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,119 | 🐛 564 | 🌐 C | 📅 2024-06-16 - A C based code-searching tool similar to ack, but faster
* [peco](https://github.com/peco/peco) ⭐ 7,909 | 🐛 6 | 🌐 Go | 📅 2026-09-05 - interactive filtering, like interactive Grep
...
* [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,581 | 🐛 429 | 🌐 Shell | 📅 2026-09-06 - the
  incredible ZSH addon.
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,189 | 🐛 143 | 🌐 Rust | 📅 2026-08-31 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [autojump](https://github.com/joelthelion/autojump) ⭐ 16,960 | 🐛 231 | 🌐 Python | 📅 2025-02-27 - remembers your
...
* [hss](https://github.com/six-ddc/hss) ⭐ 380 | 🐛 10 | 🌐 C | 📅 2025-10-17 - Never type the annoying ssh commands again.
* [freshenv](https://github.com/raiyanyahya/freshenv) ⭐ 176 | 🐛 5 | 🌐 Python | 📅 2024-09-30 - Provision, share, manage local and cloud developer environments.
...
* [watchman](https://github.com/facebook/watchman) ⭐ 13,703 | 🐛 258 | 🌐 C++ | 📅 2026-09-05 - Facebook's better
  `watch` - note it works as a service.
* [guard](https://github.com/guard/guard) ⭐ 6,438 | 🐛 67 | 🌐 Ruby | 📅 2026-07-16 - FS watch tool with a huge ecosystem of plugins
* [fswatch](https://github.com/alandipert/fswatch) ⭐ 5,589 | 🐛 45 | 🌐 C++ | 📅 2026-07-22 - a watch tool which
...
* [LiveReload](http://livereload.com/) - FS watch and preprocessor as a desktop app for `/OSX/` and `/WIN/` with complementary browser extensions
  * [guard-livereload](https://github.com/guard/guard-livereload) ⭐ 2,108 | 🐛 34 | 🌐 JavaScript | 📅 2022-11-07 - Guard plugin compatible with LiveReload's browser extensions
  * [simplehttp](https://github.com/snwfdhmp/simplehttp) ⭐ 75 | 🐛 1 | 🌐 Go | 📅 2023-03-06 Fastest and simplest way to start serving a local directory over http.
