...
Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 182,798 | 🐛 223 | 🌐 Go | 📅 2026-08-31, which was in turn inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 317,352 | 🐛 18 | 🌐 Python | 📅 2026-08-25.

### Contributing

[Guidelines](https://github.com/jondot/awesome-devenv/blob/master/CONTRIBUTING.md) ⭐ 3,336 | 🐛 41 | 📅 2024-07-29 tweaked and adapted from `awesome-go` - thanks!

But in short:

* If you think an item shouldn't be here [open an issue](https://github.com/jondot/awesome-devenv/issues/new) ⭐ 3,336 | 🐛 41 | 📅 2024-07-29
* List is alphabetically sorted

Many thanks to everyone on the [contributor list](https://github.com/jondot/awesome-devenv/graphs/contributors) ⭐ 3,336 | 🐛 41 | 📅 2024-07-29 :)
...
* [Vegeta](https://github.com/tsenart/vegeta) ⭐ 25,173 | 🐛 122 | 🌐 Go | 📅 2026-02-16
...
* [s3cmd](https://github.com/s3tools/s3cmd) ⭐ 4,906 | 🐛 311 | 🌐 Python | 📅 2025-10-22 - the S3 CLI tool for Amazon

## Diagnostics

*Tools for checking diagnosing your system while you work*

* [glances](https://github.com/nicolargo/glances) ⭐ 33,487 | 🐛 102 | 🌐 Python | 📅 2026-08-30
...
* [Mathias Bynens's](https://github.com/mathiasbynens/dotfiles) ⭐ 31,461 | 🐛 186 | 🌐 Shell | 📅 2024-08-05 - .files, including \~/.osx — sensible hacker defaults for OS X
* [Thoughtbot's](https://github.com/thoughtbot/dotfiles) ⭐ 8,171 | 🐛 16 | 🌐 Shell | 📅 2026-08-18 - A set of vim, zsh, git, and tmux configuration files
* [Zach Holman's](https://github.com/holman/dotfiles) ⭐ 7,768 | 🐛 33 | 🌐 Shell | 📅 2026-06-25 - oh-my-zsh, osx, Zsh, vi, Ruby, Git, and more
* [Paul Miller's](https://github.com/paulmillr/dotfiles) ⭐ 1,242 | 🐛 2 | 🌐 Vim Script | 📅 2026-08-31 - Colourful & robust OS X configuration files and utilities
...
* [Powerline](https://github.com/Lokaltog/powerline) ⭐ 14,806 | 🐛 242 | 🌐 Python | 📅 2026-03-11 - improved status bar for your buffers.
...
* [Dev Git Repo](https://github.com/Microsoft/vscode) ⭐ 190,100 | 🐛 20,309 | 🌐 TypeScript | 📅 2026-08-31 - Github code repository for VS Code
* [Monaco Editor Git Repo](https://github.com/microsoft/monaco-editor) ⭐ 46,630 | 🐛 848 | 🌐 JavaScript | 📅 2026-08-27 - Github code repository for underlying browser-based editor
...
* [git-extras](https://github.com/visionmedia/git-extras) ⭐ 18,100 | 🐛 96 | 🌐 Shell | 📅 2026-08-27 - GIT utilities -- repo summary, repl, changelog population, author commit percentages and more
...
* [reveal.js](https://github.com/hakimel/reveal.js/) ⭐ 72,237 | 🐛 911 | 🌐 JavaScript | 📅 2026-08-24 - markdown based presentation on your browser
...
* [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh/) ⭐ 189,481 | 🐛 578 | 🌐 Shell | 📅 2026-08-30 - A community driven framework for managing zsh configuration.
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 39,966 | 🐛 1,138 | 🌐 Haskell | 📅 2026-08-04 - Lint for shell. Will find deprecated and/or dangerous usage in shell scripts
* [fish-shell](https://github.com/fish-shell/fish-shell) ⭐ 34,105 | 🐛 568 | 🌐 Rust | 📅 2026-08-30 - The user-friendly command line shell
* [awesome-zsh-plugins](https://github.com/unixorn/awesome-zsh-plugins) ⭐ 17,982 | 🐛 6 | 🌐 Shell | 📅 2026-08-29 - List of zsh plugins usable with [zgen](https://github.com/tarjoilija/zgen) ⭐ 1,528 | 🐛 41 | 🌐 Shell | 📅 2021-07-21 and other [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh/) ⭐ 189,481 | 🐛 578 | 🌐 Shell | 📅 2026-08-30 compatible zsh frameworks
* [oh-my-fish](https://github.com/oh-my-fish/oh-my-fish) ⭐ 11,382 | 🐛 5 | 🌐 Shell | 📅 2026-08-30 - Framework for managing your fish shell configuration inspired by oh-my-zsh.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,765 | 🐛 183 | 🌐 Rust | 📅 2026-08-04 - Faster than grep, written in Rust
...
* [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,481 | 🐛 578 | 🌐 Shell | 📅 2026-08-30 - the
  incredible ZSH addon.
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,090 | 🐛 140 | 🌐 Rust | 📅 2026-08-31 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [autojump](https://github.com/joelthelion/autojump) ⭐ 16,962 | 🐛 231 | 🌐 Python | 📅 2025-02-27 - remembers your
...
* [watchman](https://github.com/facebook/watchman) ⭐ 13,701 | 🐛 258 | 🌐 C++ | 📅 2026-08-31 - Facebook's better
  `watch` - note it works as a service.
* [guard](https://github.com/guard/guard) ⭐ 6,440 | 🐛 67 | 🌐 Ruby | 📅 2026-07-16 - FS watch tool with a huge ecosystem of plugins
